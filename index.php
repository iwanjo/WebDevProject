...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.html">AfricaExplored</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item cta"><a href="#" class="nav-link"> <span>Welcome <?php echo $_SESSION['username']; ?></span></li></a>
                <li class="nav-item"><a href="logout.php" class="nav-link"> Sign Out</li></a>
                        ...
                        <div class="fields d-block d-flex">
                            ...
                            <div class="select-wrap one-third">
                                ...
                                <select name="" id="" class="form-control" placeholder="Keyword search">
                                    ...
                                    <option value="">Sossusvlei Dunes, Namibia</option>
                                    ...
                                    <option value=""> Solio Reserve, Kenya</option>
                                    ...
                                    <option value="">Lekki Conservation Centre, Nigeria</option>
                                    <option value="">Cape Verde Archipelago</option>
                                    ...
                                    <option value="">Rhumsiki Rock, Cameroon</option>
                                    <option value="">Abu Simbel, Egypt</option>
                                    <option value="">Lake Abbe, Djibouti and Ethiopia</option>
                                    <option value="">Bandiagara, Mali</option>
                                    <option value="">Chefchaouen, Morocco</option>
                                    <option value="">Blyde River Canyon, South Africa</option>
                                    <option value="">Hoggar Mountains, Algeria</option>
                                    <option value="">Fontainhas, Cape Verde</option>
                                    <option value="">Tundavala Gap, Angola</option>
                                    <option value="">Simien Mountains National Park, Ethiopia</option>
                                    <option value="">Praslin, Seychelles</option>
                                    <option value="">Makgadikgadi Pans National Park, Botswana</option>
                                    ...
                                    <option value="">Skeleton Coast, Namibia</option>
                                    <option value="">Tsingy de Bemaraha National Park, Madagascar</option>
                                    <option value="">Le Morne Brabant, Mauritius</option>
                                    <option value="">Bwindi Forest, Uganda</option>
                                    <option value="">Sudd, South Sudan</option>
                                    <option value="">Ngorongoro Crater, Tanzania</option>
                                    <option value="">Bureh Beach, Sierra Leone</option>
                                    <option value="">Kakum National Park, Ghana</option>
                                    <option value="">Sidi Bou Said, Tunisia</option>
                                    <option value="">Rwenzori Mountains, Uganda</option>
                                    <option value="">Langebaan Lagoon, South Africa</option>
                                </select>
                            </div>
                        </div>
